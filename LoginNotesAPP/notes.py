...
def addUserNotes(notes,user):
  ...
  print("You can know add notes to your file. Enter 'exit' to leave the notes. NOTE: Each entry is on one line. Press Enter and make a new input to add text to a new line")
  while more:
    userInput = input(">>>> ")
    if userInput.lower() == "exit":
      more = False
      saveOrDiscard = input("Would you like to save your notes or discard changed? ")
